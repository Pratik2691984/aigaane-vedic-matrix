/**
 * Pingala Meru-Prastāra (binomial lattice) and Sanyoga combinatorics.
...
/** Sanyoga: number of ways to choose r distinct svaras from n. */
export function sanyoga(n: number, r: number): number {
  return binomial(n, r);
}

/** Binary laghu/guru strings of length n (Pingala prastāra). */
